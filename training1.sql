...
CREATE TABLE  "CUSTOMERS" 
   (	"CUST_ID" VARCHAR(6) NOT NULL PRIMARY KEY, 
	...
	"OPENING_AMT" CHAR(12) NOT NULL, 
	"RECEIVE_AMT" CHAR(12) NOT NULL, 
	"PAYMENT_AMT" CHAR(12) NOT NULL, 
	"OUTSTANDING_AMT" CHAR(12) NOT NULL, 
...
CREATE TABLE  "ORDERS" 
   (
        "ORD_NUM" CHAR(6) NOT NULL PRIMARY KEY, 
	"ORD_AMOUNT" CHAR(12) NOT NULL, 
	"ADVANCE_AMOUNT" CHAR(12) NOT NULL, 
